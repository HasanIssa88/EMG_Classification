...
def EMG_Feature_Threshold(inFile):
    ...
    dataDir = "C:/Users\Hasan_Issa/Downloads\WinPython-64bit-3.4.3.5/python-3.4.3.amd64/MY_Examples/Project_Files/EMG_Threshold"
    
    os.chdir(dataDir)
    
    df = pd.read_csv(inFile,sep=',',skiprows=1,na_values="null",header=None,skipfooter=1,engine='python')
    
    sensors = ['EMG_radial_1','EMG_radial_2','EMG_radial_3','EMG_radial_4',
                'EMG_radial_5' ,'EMG_radial_6','EMG_special_1','EMG_special_2','EMG_special_3','EMG_special_4','Force_sensor']    
